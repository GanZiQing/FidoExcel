...
namespace ExcelAddIn2.Excel_Pane_Folder
{
    public partial class PrintToolsPane : UserControl
    {
        ...
        private void CreateAttributes()
        {
            ...
            ((DirectoryTextBox)thisAtt).AddOpenButton(dirOpenPath);
        ...
        private void PrintWorkbook(Workbook workbookToPrint, string sheetName, string pdfFileName, string folderPath)
        {
            try
            {
            ...
            try
            {
                ...
                for (int rowNum = 0; rowNum < filePaths.Length; rowNum++)
                {
                    ...
                    try
                    {
                        ...
                        {
                            pdfFileName += ".pdf";
                            PrintWorkbook(workbookToPrint, sheetName, pdfFileName, folderPath);
                        }
